  ...
  with_progress({
    ...
    future_map(1:N, function(i) {
      ...
      if(methods$e_admissible){
        e_admissible <- e_admissible_SSL(priors, train_scaled, unlabeled_scaled, test_scaled, alpha, i, h)
      ...
      if(methods$maximal){
        maximal <- maximal_SSL(priors, train_scaled, unlabeled_scaled, test_scaled, alpha, i, h)
      ...
      if(methods$SSL){
        SSL <-refernce_SSL(train_scaled, unlabeled_scaled, test_scaled, i, h)
      ...
      if(methods$SL){
        SL <- refernce_SL(train_scaled, unlabeled_scaled, test_scaled, i, h) 
      ...
      if(methods$SSL_variance){
        SSL_variance <- refernce_SSL_variance(train_scaled, unlabeled_scaled, test_scaled, i, h) 
      ...
      if(methods$SSL_entropy){
        SSL_entropy <- refernce_SSL_entropy(train_scaled, unlabeled_scaled, test_scaled, i, h)
      ...
      if(methods$M_MaxiMin){
        M_MaxiMin <- M_MaxiMin_SSL(priors, train_scaled, unlabeled_scaled, test_scaled, alpha, i, h)
      ...
      if(methods$M_MaxiMax){
        M_MaxiMax <- M_MaxiMax_SSL(priors, train_scaled, unlabeled_scaled, test_scaled, alpha, i, h)
