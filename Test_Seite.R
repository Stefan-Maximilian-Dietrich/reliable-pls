...
expected_utility_function(a = 2, labeld_data = labeld_data, unlabeled_data = unlabeled_data, mu_priori = 1, sigma_priori = 2)
gamma_maximin_function(a = 3, labeld_data = labeld_data, unlabeled_data = unlabeled_data, mu_priori_lower =0.3, mu_priori_upper= 0.6, sigma_priori = 2)
decision_function(labeld_datam = labeld_datam, unlabeled_data = unlabeled_data, mu_priori_lower = 0.3, mu_priori_upper = 0.6, sigma_priori = 2) 
