...
alpha_cut(labeled_data = data100, unlabeled_data = data20_u, test_data = data500_t, target =  "y", glm_formula = formula , mu_priori_lower = mu_priori_lower, mu_priori_upper = mu_priori_upper, sigma_priori = sigma_priori, alpha = alpha)
